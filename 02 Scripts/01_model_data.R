...
#------------------------------------------------------------------------------
# Set constants
# Note that advanced stats are not available prior to 2017
MIN_YEAR <- 2012
MAX_YEAR <- 2020
...
SC_2020 <- read_csv(paste0("//qatlpcfs001/users/OArmstrong/Desktop/",
                           "Learning & Development/Modelling AFL Brownlow/",
                           "01 Data Sets/2020_SC.csv"), 
                     col_types = cols(X1 = col_skip()))

# Import supercoach data for 2020
AF_2020 <- read_csv(paste0("//qatlpcfs001/users/OArmstrong/Desktop/",
                           "Learning & Development/Modelling AFL Brownlow/",
                           "01 Data Sets/2020_AF.csv"),
                    col_types = cols(X1 = col_skip()))

# Import coaches votes
coaches_votes <- read_csv(paste0("//qatlpcfs001/users/OArmstrong/Desktop/",
                                 "Learning & Development/Modelling AFL Brownlow/",
...
joinYear <- tibble(season = 
                     rep(c(2011, 2012, 2013, 2014, 2015, 2016, 2017,
                           2018, 2019), 1401))
